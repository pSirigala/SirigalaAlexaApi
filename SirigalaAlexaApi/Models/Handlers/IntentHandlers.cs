...
namespace SirigalaAlexaApi.Models.Handlers
{
    public class IntentHandlers
    {
        ...
        public static AlexaResponse SayHelloIntentHandler(AlexaRequest request)
        {
            try
            {
                var response = new AlexaResponse();
                ...
                //response.Response.OutputSpeech.Ssml = "<speak> <audio src=\"https://s3-us-west-2.amazonaws.com/quorralynefiles/computerbeep.mp3\" ></audio> Yes commander. </speak>";
                response.Response.Reprompt.OutputSpeech.Text = "Hello, this is Lishitha. I hope you are doing good.";
                response.Response.ShouldEndSession = false;
